...
def read_config(config_path='/home/xwl/temp/pylearning/dair_v2x_i_dataset_vis-master/config/config.yaml'):
        ...
        for index in files_list:
            ...
            with open(os.path.join(output_path,output_name[0]+".txt"), 'wt') as f:
                ...
                for line in label:
                    #print("line: ",line,"\n")
                    f.write(line['type']+" ")
                    f.write(str(line['truncated_state'])+" ")
                    f.write(str(line['occluded_state'])+" ")
                    f.write(str(line['alpha'])+" ")
                    f.write(str(line['2d_box']['xmin'])+" ")
                    f.write(str(line['2d_box']['ymin'])+" ")
                    f.write(str(line['2d_box']['xmax'])+" ")
                    f.write(str(line['2d_box']['ymax'])+" ")

                    f.write(str(line['3d_dimensions']['h'])+" ")
                    f.write(str(line['3d_dimensions']['w'])+" ")
                    f.write(str(line['3d_dimensions']['l'])+" ")

                    f.write(str(line['3d_location']['x'])+" ")
                    f.write(str(line['3d_location']['y'])+" ")
                    f.write(str(line['3d_location']['z'])+" ")

                    f.write(str(line['rotation'])+" "+"\n")
        ...
        for index in lidar_files_list:
            ...
            with open(os.path.join(output_path,output_name[0]+".txt"), 'wt') as f:
                ...
                for camera_line,lidar_line in zip(camera_label,lidar_label):
                    ...
                    f.write(str(camera_line['truncated_state'])+" ")
                    f.write(str(camera_line['occluded_state'])+" ")
                    f.write(str(camera_line['alpha'])+" ")
                    f.write(str(camera_line['2d_box']['xmin'])+" ")
                    f.write(str(camera_line['2d_box']['ymin'])+" ")
                    f.write(str(camera_line['2d_box']['xmax'])+" ")
                    f.write(str(camera_line['2d_box']['ymax'])+" ")

                    f.write(str(lidar_line['3d_dimensions']['h'])+" ")
                    f.write(str(lidar_line['3d_dimensions']['w'])+" ")
                    f.write(str(lidar_line['3d_dimensions']['l'])+" ")

                    f.write(str(camera_line['3d_location']['x'])+" ")
                    f.write(str(camera_line['3d_location']['y'])+" ")
                    f.write(str(lidar_line['3d_location']['z'])+" ")

                    f.write(str(camera_line['rotation'])+" "+"\n")
